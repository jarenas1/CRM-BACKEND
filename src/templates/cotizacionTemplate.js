...
module.exports = function buildCotizacionHtml(data, numero, totales, firmante = {}) {
  ...
  const filas = (data.items || []).map((it, i) => {
    ...
    const cell = `padding:4px 8px;border-bottom:1px solid ${CO.line};`;
  ...
  const rows =
    ...
    + '<th style="padding:6px 6px;text-align:center;">Ítem</th>'
    + '<th style="padding:6px 6px;text-align:left;">Descripción</th>'
    + '<th style="padding:6px 6px;text-align:center;">Cant.</th>'
    + '<th style="padding:6px 6px;text-align:center;">Ingreso</th>'
    + '<th style="padding:6px 6px;text-align:center;">Salida</th>'
    + '<th style="padding:6px 6px;text-align:center;">Noches</th>'
    + '<th style="padding:6px 6px;text-align:center;">Pers.</th>'
    + '<th style="padding:6px 6px;text-align:right;">Tarifa</th>'
    + '<th style="padding:6px 6px;text-align:right;">Subtotal</th>'
    ...
    // firma
    + '<tr><td style="padding:8px 40px 12px 40px;font-family:Arial,Helvetica,sans-serif;">'
    + firmaImg
